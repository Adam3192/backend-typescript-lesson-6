...
import { allCoffee, oneCoffee, addCoffeePage, editCoffeePage, addCoffee, editCoffee, deleteCoffee } from '../controllers/coffeeController';
...
// POST /coffee/edit/:coffeeId - edit coffee item
